...
using StudentApp.Sessions;
using StudentApp.Web.Controllers.Results;
using StudentApp.Web.Models;
using StudentApp.Web.Models.Account;
...
{
    public class AccountController : StudentAppControllerBase
    {
